        ...
        <div className="col-md-9">
          <div className="card-body">
            ...
            <small className="text-muted">
              By:{" "}
              {user.id != reviewFriend.id ? (
                <a href={`/profileuserid/${reviewFriend.id}`}>
                  {reviewFriend.username}
                </a>
              ) : (
                <a href={`/profile`}>{reviewFriend.username}</a>
              )}
            </small>
            ...
            <p className="card-text">
              <small className="text-muted">
                ...
                <small className="text-muted">
                  Price:{" "}
                  {reviews.price !== 0 && reviews.price !== null
                    ? formattedPrice
                    : "N/A"}
                </small>
              </small>{" "}
